...
SCHEDULE = [{
    ...
    "timeout": 14400  # Таймаут 4 часа на копирование и синхранизацию с облачным хранилищем, затем процесс прерывается и выключение компьютера, в рамках процесса, может быть прервано
}]