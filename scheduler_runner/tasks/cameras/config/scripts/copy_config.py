...
SCHEDULE = [{
    ...
    "timeout": 18000  # Таймаут 5 часов на копирование и синхранизацию с облачным хранилищем, затем процесс прерывается и выключение компьютера, в рамках процесса, может быть прервано
}]