"""
Скрипт для прямого запуска OzonCarriagesReportScript

Этот скрипт запускает основной скрипт напрямую, чтобы проверить его работу.
"""
import sys
import os
...
def direct_run():
    ...
    print("=== Прямой запуск OzonCarriagesReportScript ===")
