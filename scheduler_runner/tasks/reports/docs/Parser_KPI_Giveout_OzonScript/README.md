...
- Используются специфичные селекторы для извлечения данных о перевозках
- Реализована двухэтапная обработка: сначала прямые, затем возвратные перевозки
- Используется централизованная система логирования и обработки ошибок